...
def get_batch_ids(url, token, batch_type="joshuashirn_Batch"):
    query = {
        'required': {
            'data': '*'
        },
...
def get_ids_in_batch(url, token,batch_ids, batch_type="joshuashirn_Batch"):
    query = {
        'required': {
            'data': '*'
        },
...
def get_all_JV(url, token, sample_ids, jv_type="joshuashirn_JVmeasurement"):
    # collect the results of the sample, in this case it are all the annealing temperatures
...
def get_all_eqe(url, token, sample_ids, eqe_type="joshuashirn_EQEmeasurement"):
    #
    query = {
        'required': {
            'metadata': '*'
...
def get_all_mppt(url, token, sample_ids, mppt_type="joshuashirn_SimpleMPPTracking"):
    #
    query = {
        'required': {
            'metadata': '*'
